...
public class XunitTestFrameworkDiscovererTests
{
    ...
    public static class FindByAssembly
    {
        ...
        public static void GuardClauses()
        {
            ...
            Assert.Throws<ArgumentNullException>("options", () => framework.Find(includeSourceInformation: false, messageSink: Substitute.For<IMessageSink>(), discoveryOptions: null));
        }
    ...
    public class FindByTypeName
    {
        ...
        public static void GuardClauses()
        {
            ...
            Assert.Throws<ArgumentNullException>("messageSink", () => framework.Find(typeName, includeSourceInformation: false, messageSink: null, discoveryOptions: options));
            Assert.Throws<ArgumentNullException>("options", () => framework.Find(typeName, includeSourceInformation: false, messageSink: sink, discoveryOptions: null));
        }
